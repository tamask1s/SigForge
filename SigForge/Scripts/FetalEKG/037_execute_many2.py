...
FetalEkg(DATADIR\recording_2021-03-15_18-14-46_Recording_FEBB.bdf, 1 2, 1, 1, RESULTDIR\46_Recording_FEBB.bin);
FetalEkg(DATADIR\recording_2021-03-15_18-14-46_Recording_FEBB.bdf, 1 3, 0, 1, RESULTDIR\46_Recording_FEBB2.bin);
FetalEkg(DATADIR\recording_GulyasDzseniferINA821_01.bdf, 1 2, 1, 1, RESULTDIR\recording_GulyasDzseniferINA821_01.bin);
FetalEkg(DATADIR\58.bin, 1 20, 0, 0, RESULTDIR\58.bin);
FetalEkg(DATADIR\58.bin, 1 20, 1, 1, RESULTDIR\582.bin);
FetalEkg(DATADIR\recording_SeresJuditINA821_01.bdf, 1 2, 0, 0, RESULTDIR\recording_SeresJuditINA821_01.bin);
FetalEkg(DATADIR\recording_SeresJuditINA821_01.bdf, 1 2, 1, 1, RESULTDIR\recording_SeresJuditINA821_012.bin);
