...
DFileType DllFileType = {8, "*.bin", "BinMx Data Format"};
...
extern "C"
{
    ...
    DllExport bool DOpenFile(int aData, char* FileName, const bool Write = true)
    {
        ...
        double* sampling_rate = (double*)Buffer;
        int* nr_channels = (int*)(Buffer + 8);
        //double* nr_cols = (double*)(Buffer + 16);
        //int nr_cols2 = *nr_cols;
        //printf("BinMX nr cols: %d \n", nr_cols2);
        //double* total_samples = (double*)(Buffer + 16);
