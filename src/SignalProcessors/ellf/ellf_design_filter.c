...
double* filterdenominatorref, *filternumeratorref;
...
{
    filterdenominatorref = filterdenominator;
    filternumeratorref   = filternumerator;
    dbfac = 10.0 / log(10.0);
    ...
    {
specerr:
        printf( "Filter design: Specification error\n" );
        return 0;
    }
...
///printf( "%2d %lf %lf\n", j, aa[j], pp[j] );
        ...
        filterdenominatorref[j] = aa[j];
        filternumeratorref[j]   = pp[j];
    }
 ...
 */
int quadf( double x, double y, int pzflg )
